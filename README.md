...
```bash
git clone https://github.com/23f2005532/tdsp2.git
cd tdsp2
```
...
For questions or issues, please open an issue on the [GitHub repository](https://github.com/23f2005532/tdsp2).
